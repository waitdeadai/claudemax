...
export function initCommand(): Command {
  return new Command("init")
    ...
    .action((opts: { target: string; force: boolean; darkPatterns: boolean }) => {
      ...
      console.log(
        kleur.dim(
          "\n  Slash commands available: /ask /cmax /opusolo /spec /goal /tdd /orchestrate /verify /deepresearch /audit /investigate /codesearch /introspect /specqa /parallel /hive /council /review /ship /align /overnight /taste /deepretaste /agentfactory /agentteams /route /memory /harness-audit",
        ),
      );
